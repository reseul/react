...
function createShorthandFromValue(
  ...
  let TweakedComponent
  if (Component === 'div') {
    TweakedComponent = RN.View
  } else if (Component === 'input') {
    TweakedComponent = RN.TextInput
  } else if (Component === 'button') {
    TweakedComponent = RN.View
  } else if (Component === 'span') {
    TweakedComponent = RN.Text
  } else if (Component === 'p') {
    TweakedComponent = RN.Text
  } else if (Component === 'h1') {
    TweakedComponent = RN.Text
  } else if (Component === 'ul') {
    TweakedComponent = RN.ScrollView
  } else if (Component === 'li') {
    TweakedComponent = RN.View
  } else {
    TweakedComponent = Component
  }
  ...
  if (render) {
    return render(TweakedComponent, props)
  }
  ...
  if (valIsPrimitive || valIsPropsObject) return React.createElement(TweakedComponent, props)
